...
resource "helm_release" "cluster-autoscaler" {
  ...
  set = [
    ...
    { name = "rbac.serviceAccount.name", value = var.autoscaler_service_account_name },
    { name = "rbac.serviceAccount.annotations.eks\\.amazonaws\\.com/role-arn", value = module.iam_assumable_role_admin.iam_role_arn, type = "string" },
